  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-12">
      <div className="rounded-2xl bg-card p-8 text-center shadow-sm ring-1 ring-border">
        <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-deep-ocean-500/15">
          <CheckCircle className="h-8 w-8 text-deep-ocean-600" />
        </div>
        ...
        <div className="mb-8 space-y-3 rounded-xl bg-dark-teal-50 p-5 text-left">
          <h3 className="font-bold text-dark-teal-800">{selectedTaller.title}</h3>
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-sm text-dark-teal-700">
        ...
        <div className="mb-8 rounded-xl bg-pale-oak-50 p-4 text-left">
          <div className="flex gap-3">
            <AlertCircle className="mt-0.5 h-4 w-4 shrink-0 text-pale-oak-500" />
            <div>
              <p className="text-sm font-semibold text-dark-teal-800">
        ...
        <Button
          ...
          className="w-full bg-dark-teal-600 text-primary-foreground hover:bg-dark-teal-700"
        >
