...
export function HomeView() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-60px)] flex-col">
      {/* Hero */}
      <section className="relative overflow-hidden bg-teal-800 px-4 py-16 md:py-24">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-ocean-500" />
          <div className="absolute -bottom-20 -left-20 h-72 w-72 rounded-full bg-teal-500" />
        </div>
        <div className="relative mx-auto max-w-3xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-teal-700/50 px-4 py-1.5 text-sm text-teal-100">
          ...
          <h1 className="mb-4 text-balance text-4xl font-bold tracking-tight text-primary-foreground md:text-5xl lg:text-6xl">
            No ensenamos.{" "}
            <span className="text-ocean-400">Ejecutamos juntos.</span>
          </h1>
          <p className="mx-auto mb-10 max-w-xl text-pretty text-lg leading-relaxed text-teal-100/80">
            Conectamos emprendedores +50 con practicantes universitarios para
          ...
          <div className="mx-auto flex max-w-xl flex-col gap-4 sm:flex-row">
            ...
            >
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-teal-50 text-teal-600 transition-colors group-hover:bg-teal-600 group-hover:text-primary-foreground">
                <Users className="h-7 w-7" />
              </div>
              <div className="flex-1">
                <p className="font-bold text-teal-900">Soy Emprendedor +50</p>
                <p className="text-sm text-platinum-500">
                  Quiero participar en un taller gratuito
                </p>
              </div>
              <ArrowRight className="h-5 w-5 text-platinum-300 transition-transform group-hover:translate-x-1 group-hover:text-teal-600" />
            </button>

            <button
              onClick={handlePracticante}
              className="group flex flex-1 items-center gap-4 rounded-xl bg-teal-700/40 p-5 text-left shadow-lg backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:shadow-xl"
            >
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-ocean-500/20 text-ocean-400 transition-colors group-hover:bg-ocean-500 group-hover:text-teal-900">
              ...
              <ArrowRight className="h-5 w-5 text-teal-300/50 transition-transform group-hover:translate-x-1 group-hover:text-ocean-400" />
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="bg-background px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-2 text-center text-sm font-semibold uppercase tracking-wider text-teal-600">
            Como funciona
          </h2>
          <p className="mb-12 text-center text-2xl font-bold text-teal-900 md:text-3xl">
      ...
      {/* CTA */}
      <section className="bg-oak-100 px-4 py-12">
